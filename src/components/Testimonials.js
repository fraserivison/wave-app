...
const Testimonials = () => {
  const feedback = [
    ...
    { id: 3, name: "DJ Sammi", quote: "Love the community here, it's for electric music lovers- plenty of them!" },
  { id: 4, name: "Taylor Made", quote: "I can't believe how easy it is to find new tracks here. Absolute belters!!" },
